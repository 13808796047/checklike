  ...
  <div id="ser" class="services">
    <div class="container">
      <div class="services-head text-center">
        <h3>维普论文检测系统全新升级</h3>
        <p>
          采用国际领先的海量论文动态语义跨域识别加指纹比对技术，通过运用最新的云检测服务部署使其能够快捷、稳定、准确地检测到文章中存在的抄袭和不当引用现象，为教育机构、科研单位、各级论文评审单位和发表单位提供了论文原创性和新颖性评价的重要依据。</p>
      </div>
  ...
  <script>
    $(function () {
      ...
      axios.get("/official_account").then(res=>{
          ...
          console.log("hahahahah",wechatFlag)
        }).catch(err=>{
