...
<div class="grid grid-cols-12 gap-4">
  ...
  <div style="padding:30px 50px;" class="freecheckleft">
    ...
    <div style="font-size:13px;color:#A9A9A9;text-align:center;margin:15px 0;">活动时间：2020-10-01 至2021-07-31</div>
    ...
    <a class="btn btn-primary btn-sm sbtn" href="javascript:;" data-toggle="modal" data-target="#staticBackdrop" type="button" style="color:#fff;margin-top:30px;padding:10px 15px;font-size:18px;background:#0b81fb;">立即去提交论文</a>
    </div>
    @else
    <div style="text-align:center;vertical-align:middle;">
    <a href="/categories/1" type="button" style="color:#fff;margin-top:30px;padding:10px 15px;font-size:18px;background:#0b81fb;" class="btn btn-primary btn-sm sbtn">立即去提交论文</a>
    </div>
    @endguest
