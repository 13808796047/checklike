...
<div class="grid grid-cols-12 gap-4">
  ...
  <div style="padding:30px 50px;">
    ...
    <p style="font-size:13px;color:#A9A9A9;text-align:center;margin:5px 0;">活动时间：2020-10-01 至2021-07-31</p>
    <p style="font-size:15px;text-indent:2em;line-height:2;">CheckLike论文相似度检测系统采用国际领先的海量论文动态语义跨域识别加指纹比对技术，通过运用最新的云检测服务部署使其能够快捷、稳定、准确地检测到文章中存在的抄袭和不当引用现象，实现了对学术不端行为的检测服务。</p >
    <p style="font-size:15px;text-indent:2em;line-height:2;">通过系统检测可快速准确地检测出论文中不当引用、过度引用甚至是抄袭、伪造、篡改等学术不端行为，可自动生成检测报告，并支持PDF、网页等浏览格式。详细的检测报告通过不同颜色标注相似片段、引用片段、专业用语，形象直观地显示相似内容比对、相似文献汇总、引用片段出处、总相似比、引用率、复写率和自写率等重要指标，为教育机构、科研单位、各级论文评审单位和发表单位提供了论文原创性和新颖性评价的重要依据。经过不断发展和努力，已经在众多行业和部门得到了广泛使用，受到了用户的高度评价。</p>
    <p style="font-size:15px;text-indent:2em;line-height:2;">为了让更多用户体验到CheckLike的检测效果，我们推出免费查重活动：</p>
    <p style="font-size:15px;text-indent:2em;line-height:2;"><b>活动对象：</b>所有用户</p>
    <p style="font-size:15px;text-indent:2em;line-height:2;"><b>规则说明：</b>活动期间，所有用户均可使用CheckLike专业版免费查重一篇1万字以内的论文（一万字以内免费，超过一万字部分按3元/万字收费）。</p >
    <p style="font-size:15px;text-indent:2em;line-height:2;"><b>活动时间：</b>2020-10-01 至2021-07-31</p>
