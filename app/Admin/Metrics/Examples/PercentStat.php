...
class PercentStat extends Donut
{
...
//        $this->subTitle('Last 30 days');
    ...
    public function handle(Request $request)
    {
        ...
        $activedData = CouponCode::couponCodeActived(CouponCode::TYPE_PERCENT, $date)->count();
        $usedData = Order::usedCouponCode(CouponCode::TYPE_PERCENT, $date)->count();
